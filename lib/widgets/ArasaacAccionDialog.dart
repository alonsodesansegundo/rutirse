...
///Widget que consiste en un cuadro de diálogo para seleccionar un pictograma como Accion haciendo uso de la API de ARASAAC
class ArasaacAccionDialog extends StatefulWidget {
  ...
  ///Constructor de la clase ArasaacAccionDialog
  ArasaacAccionDialog({
...
/// Estado asociado al widget [ArasaacAccionDialog] que gestiona la lógica
